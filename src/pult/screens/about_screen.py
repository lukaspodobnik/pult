        ...
        with FormDialog("ÜBER PULT / LIZENZ", id="about-dialog"):
            with VerticalScroll(id="about-content"):
                yield Static(
                    ...
                    "Logo-Schriftzug: Calvin von Stevonnie Ross, erzeugt mit TAAG (patorjk.com).\n"
                    "Mit ausdrücklicher Erlaubnis für App, Dateien und Screenshots, "
                    "einschließlich abgeleiteter Werke unter der GPL.\n\n"
                    "BIBLIOTHEKEN\n"
